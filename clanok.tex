...
\section{História umelej inteligencie vo videohrách} \label{kapitola1}
...
\subsection{Prvé použitia umelej inteligencie vo videohrách} \label{kapitola1.1}
...
\subsection{Videohry pred rokom 2000 používajúce umelú inteligenciu} \label{kapitola1.2}
